...
const SocialLinks = () => {
  ...
  return (
    <div className="w-full bg-gradient-to-br from-white/10 to-white/5 rounded-2xl p-4 md:p-6 backdrop-blur-xl">
      <h3
        ...
        {socialLinks.map((link, index) => (
          <a
            ...
            className="group relative flex items-center gap-3 p-3 md:p-4 rounded-xl 
                       ...
                       hover:border-white/20 transition-all duration-500 flex-1 sm:flex-none justify-center"
            data-aos="fade-up" 
          ...
          >
            ...
            <div className="relative flex items-center justify-center">
              ...
              <div className="relative p-2 rounded-lg">
                <link.icon
                  className="w-5 h-5 md:w-6 md:h-6 transition-all duration-500 group-hover:scale-110"
                  style={{ color: link.color }}
                />
              </div>
            </div>

            {/* Text Container - hidden on very small screens, visible on larger */}
            ...
            <ExternalLink
              className="w-4 h-4 text-gray-500 group-hover:text-white ml-auto hidden sm:block
